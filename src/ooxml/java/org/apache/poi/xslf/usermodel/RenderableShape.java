...
class RenderableShape {
    ...
    private static float[] getDashPattern(LineDash lineDash, float lineWidth) {
        switch (lineDash) {
            ...
            case DASH_DOT:
                return new float[]{4 * lineWidth, 3 * lineWidth, lineWidth, 3 * lineWidth};
            case LG_DASH:
                return new float[]{8 * lineWidth, 3 * lineWidth};
            case LG_DASH_DOT:
                return new float[]{8 * lineWidth, 3 * lineWidth, lineWidth, 3 * lineWidth};
            case LG_DASH_DOT_DOT:
                return new float[]{8 * lineWidth, 3 * lineWidth, lineWidth, 3 * lineWidth, lineWidth, 3 * lineWidth};
            default:
                return null;
        }
    }
