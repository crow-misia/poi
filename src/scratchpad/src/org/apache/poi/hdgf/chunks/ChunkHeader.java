...
public abstract class ChunkHeader {
	...
	public static ChunkHeader createChunkHeader(int documentVersion, byte[] data, int offset) {
		if(documentVersion >= 6) {
			...
			ch.unknown3 = (short)LittleEndian.getUByte(data, offset + 18);
			...
			ch.unknown2 = (short)LittleEndian.getUByte(data, offset + 4);
			ch.unknown3 = (short)LittleEndian.getUByte(data, offset + 5);
