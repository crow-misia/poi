    ...
    implements HDFType
{
    ...
    private  byte field_1_formatFlags;
        private static final BitField  fFacingPages = BitFieldFactory.getInstance(0x01);
        private static final BitField  fWidowControl = BitFieldFactory.getInstance(0x02);
        private static final BitField  fPMHMainDoc = BitFieldFactory.getInstance(0x04);
        private static final BitField  grfSupression = BitFieldFactory.getInstance(0x18);
        private static final BitField  fpc = BitFieldFactory.getInstance(0x60);
        private static final BitField  unused1 = BitFieldFactory.getInstance(0x80);
    private  byte field_2_unused2;
    private  short field_3_footnoteInfo;
        private static final BitField  rncFtn = BitFieldFactory.getInstance(0x0003);
        private static final BitField  nFtn = BitFieldFactory.getInstance(0xfffc);
    private  byte field_4_fOutlineDirtySave;
    private  byte field_5_docinfo;
        private static final BitField  fOnlyMacPics = BitFieldFactory.getInstance(0x01);
        private static final BitField  fOnlyWinPics = BitFieldFactory.getInstance(0x02);
        private static final BitField  fLabelDoc = BitFieldFactory.getInstance(0x04);
        private static final BitField  fHyphCapitals = BitFieldFactory.getInstance(0x08);
        private static final BitField  fAutoHyphen = BitFieldFactory.getInstance(0x10);
        private static final BitField  fFormNoFields = BitFieldFactory.getInstance(0x20);
        private static final BitField  fLinkStyles = BitFieldFactory.getInstance(0x40);
        private static final BitField  fRevMarking = BitFieldFactory.getInstance(0x80);
    private  byte field_6_docinfo1;
        private static final BitField  fBackup = BitFieldFactory.getInstance(0x01);
        private static final BitField  fExactCWords = BitFieldFactory.getInstance(0x02);
        private static final BitField  fPagHidden = BitFieldFactory.getInstance(0x04);
        private static final BitField  fPagResults = BitFieldFactory.getInstance(0x08);
        private static final BitField  fLockAtn = BitFieldFactory.getInstance(0x10);
        private static final BitField  fMirrorMargins = BitFieldFactory.getInstance(0x20);
        private static final BitField  unused3 = BitFieldFactory.getInstance(0x40);
        private static final BitField  fDfltTrueType = BitFieldFactory.getInstance(0x80);
    private  byte field_7_docinfo2;
        private static final BitField  fPagSupressTopSpacing = BitFieldFactory.getInstance(0x01);
        private static final BitField  fProtEnabled = BitFieldFactory.getInstance(0x02);
        private static final BitField  fDispFormFldSel = BitFieldFactory.getInstance(0x04);
        private static final BitField  fRMView = BitFieldFactory.getInstance(0x08);
        private static final BitField  fRMPrint = BitFieldFactory.getInstance(0x10);
        private static final BitField  unused4 = BitFieldFactory.getInstance(0x20);
        private static final BitField  fLockRev = BitFieldFactory.getInstance(0x40);
        private static final BitField  fEmbedFonts = BitFieldFactory.getInstance(0x80);
    private  short field_8_docinfo3;
        private static final BitField  oldfNoTabForInd = BitFieldFactory.getInstance(0x0001);
        private static final BitField  oldfNoSpaceRaiseLower = BitFieldFactory.getInstance(0x0002);
        private static final BitField  oldfSuppressSpbfAfterPageBreak = BitFieldFactory.getInstance(0x0004);
        private static final BitField  oldfWrapTrailSpaces = BitFieldFactory.getInstance(0x0008);
        private static final BitField  oldfMapPrintTextColor = BitFieldFactory.getInstance(0x0010);
        private static final BitField  oldfNoColumnBalance = BitFieldFactory.getInstance(0x0020);
        private static final BitField  oldfConvMailMergeEsc = BitFieldFactory.getInstance(0x0040);
        private static final BitField  oldfSupressTopSpacing = BitFieldFactory.getInstance(0x0080);
        private static final BitField  oldfOrigWordTableRules = BitFieldFactory.getInstance(0x0100);
        private static final BitField  oldfTransparentMetafiles = BitFieldFactory.getInstance(0x0200);
        private static final BitField  oldfShowBreaksInFrames = BitFieldFactory.getInstance(0x0400);
        private static final BitField  oldfSwapBordersFacingPgs = BitFieldFactory.getInstance(0x0800);
        private static final BitField  unused5 = BitFieldFactory.getInstance(0xf000);
    ...
    private  short field_23_Edn;
        private static final BitField  rncEdn = BitFieldFactory.getInstance(0x0003);
        private static final BitField  nEdn = BitFieldFactory.getInstance(0xfffc);
    private  short field_24_Edn1;
        private static final BitField  epc = BitFieldFactory.getInstance(0x0003);
        private static final BitField  nfcFtnRef1 = BitFieldFactory.getInstance(0x003c);
        private static final BitField  nfcEdnRef1 = BitFieldFactory.getInstance(0x03c0);
        private static final BitField  fPrintFormData = BitFieldFactory.getInstance(0x0400);
        private static final BitField  fSaveFormData = BitFieldFactory.getInstance(0x0800);
        private static final BitField  fShadeFormData = BitFieldFactory.getInstance(0x1000);
        private static final BitField  fWCFtnEdn = BitFieldFactory.getInstance(0x8000);
    ...
    private  short field_32_view;
        private static final BitField  wvkSaved = BitFieldFactory.getInstance(0x0007);
        private static final BitField  wScaleSaved = BitFieldFactory.getInstance(0x0ff8);
        private static final BitField  zkSaved = BitFieldFactory.getInstance(0x3000);
        private static final BitField  fRotateFontW6 = BitFieldFactory.getInstance(0x4000);
        private static final BitField  iGutterPos = BitFieldFactory.getInstance(0x8000);
    private  int field_33_docinfo4;
        private static final BitField  fNoTabForInd = BitFieldFactory.getInstance(0x00000001);
        private static final BitField  fNoSpaceRaiseLower = BitFieldFactory.getInstance(0x00000002);
        private static final BitField  fSupressSpdfAfterPageBreak = BitFieldFactory.getInstance(0x00000004);
        private static final BitField  fWrapTrailSpaces = BitFieldFactory.getInstance(0x00000008);
        private static final BitField  fMapPrintTextColor = BitFieldFactory.getInstance(0x00000010);
        private static final BitField  fNoColumnBalance = BitFieldFactory.getInstance(0x00000020);
        private static final BitField  fConvMailMergeEsc = BitFieldFactory.getInstance(0x00000040);
        private static final BitField  fSupressTopSpacing = BitFieldFactory.getInstance(0x00000080);
        private static final BitField  fOrigWordTableRules = BitFieldFactory.getInstance(0x00000100);
        private static final BitField  fTransparentMetafiles = BitFieldFactory.getInstance(0x00000200);
        private static final BitField  fShowBreaksInFrames = BitFieldFactory.getInstance(0x00000400);
        private static final BitField  fSwapBordersFacingPgs = BitFieldFactory.getInstance(0x00000800);
        private static final BitField  fSuppressTopSPacingMac5 = BitFieldFactory.getInstance(0x00010000);
        private static final BitField  fTruncDxaExpand = BitFieldFactory.getInstance(0x00020000);
        private static final BitField  fPrintBodyBeforeHdr = BitFieldFactory.getInstance(0x00040000);
        private static final BitField  fNoLeading = BitFieldFactory.getInstance(0x00080000);
        private static final BitField  fMWSmallCaps = BitFieldFactory.getInstance(0x00200000);
    private  short field_34_adt;
    private  byte[] field_35_doptypography;
    private  byte[] field_36_dogrid;
    private  short field_37_docinfo5;
        private static final BitField  lvl = BitFieldFactory.getInstance(0x001e);
        private static final BitField  fGramAllDone = BitFieldFactory.getInstance(0x0020);
        private static final BitField  fGramAllClean = BitFieldFactory.getInstance(0x0040);
        private static final BitField  fSubsetFonts = BitFieldFactory.getInstance(0x0080);
        private static final BitField  fHideLastVersion = BitFieldFactory.getInstance(0x0100);
        private static final BitField  fHtmlDoc = BitFieldFactory.getInstance(0x0200);
        private static final BitField  fSnapBorder = BitFieldFactory.getInstance(0x0800);
        private static final BitField  fIncludeHeader = BitFieldFactory.getInstance(0x1000);
        private static final BitField  fIncludeFooter = BitFieldFactory.getInstance(0x2000);
        private static final BitField  fForcePageSizePag = BitFieldFactory.getInstance(0x4000);
        private static final BitField  fMinFontSizePag = BitFieldFactory.getInstance(0x8000);
    private  short field_38_docinfo6;
        private static final BitField  fHaveVersions = BitFieldFactory.getInstance(0x0001);
        private static final BitField  fAutoVersions = BitFieldFactory.getInstance(0x0002);
    ...
    private  int field_43_virusinfo;
        private static final BitField  fVirusPrompted = BitFieldFactory.getInstance(0x0001);
        private static final BitField  fVirusLoadSafe = BitFieldFactory.getInstance(0x0002);
        private static final BitField  KeyVirusSession30 = BitFieldFactory.getInstance(0xfffffffc);
