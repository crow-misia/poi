    ...
    implements HDFType
{
    ...
    private  int field_2_format_flags;
        private static final BitField  fBold = BitFieldFactory.getInstance(0x0001);
        private static final BitField  fItalic = BitFieldFactory.getInstance(0x0002);
        private static final BitField  fRMarkDel = BitFieldFactory.getInstance(0x0004);
        private static final BitField  fOutline = BitFieldFactory.getInstance(0x0008);
        private static final BitField  fFldVanish = BitFieldFactory.getInstance(0x0010);
        private static final BitField  fSmallCaps = BitFieldFactory.getInstance(0x0020);
        private static final BitField  fCaps = BitFieldFactory.getInstance(0x0040);
        private static final BitField  fVanish = BitFieldFactory.getInstance(0x0080);
        private static final BitField  fRMark = BitFieldFactory.getInstance(0x0100);
        private static final BitField  fSpec = BitFieldFactory.getInstance(0x0200);
        private static final BitField  fStrike = BitFieldFactory.getInstance(0x0400);
        private static final BitField  fObj = BitFieldFactory.getInstance(0x0800);
        private static final BitField  fShadow = BitFieldFactory.getInstance(0x1000);
        private static final BitField  fLowerCase = BitFieldFactory.getInstance(0x2000);
        private static final BitField  fData = BitFieldFactory.getInstance(0x4000);
        private static final BitField  fOle2 = BitFieldFactory.getInstance(0x8000);
    private  int field_3_format_flags1;
        private static final BitField  fEmboss = BitFieldFactory.getInstance(0x0001);
        private static final BitField  fImprint = BitFieldFactory.getInstance(0x0002);
        private static final BitField  fDStrike = BitFieldFactory.getInstance(0x0004);
        private static final BitField  fUsePgsuSettings = BitFieldFactory.getInstance(0x0008);
    ...
    private  short field_33_Highlight;
        private static final BitField  icoHighlight = BitFieldFactory.getInstance(0x001f);
        private static final BitField  fHighlight = BitFieldFactory.getInstance(0x0020);
        private static final BitField  kcd = BitFieldFactory.getInstance(0x01c0);
        private static final BitField  fNavHighlight = BitFieldFactory.getInstance(0x0200);
        private static final BitField  fChsDiff = BitFieldFactory.getInstance(0x0400);
        private static final BitField  fMacChs = BitFieldFactory.getInstance(0x0800);
        private static final BitField  fFtcAsciSym = BitFieldFactory.getInstance(0x1000);
