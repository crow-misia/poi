...
public final class TestNPOIFSFileSystem extends TestCase {
   ...
   public void testBasicOpen() throws Exception {
      ...
      try (final NPOIFSFileSystem fsA = new NPOIFSFileSystem(_inst.getFile("BlockSize4096.zvi"));
           final NPOIFSFileSystem fsB = new NPOIFSFileSystem(_inst.openResourceAsStream("BlockSize4096.zvi"))) {
          for(NPOIFSFileSystem fs : new NPOIFSFileSystem[] {fsA,fsB}) {
   ...
   public void testGetFreeBlockWithSpare() throws Exception {
      try (final NPOIFSFileSystem fs = new NPOIFSFileSystem(_inst.getFile("BlockSize512.zvi"))) {
   ...
   public void testGetFreeBlockWithNoneSpare() throws Exception {
      try (final NPOIFSFileSystem fs = new NPOIFSFileSystem(_inst.openResourceAsStream("BlockSize512.zvi"))) {
          int free;
          ...
          if(1==2) {
              ...
              try (final NPOIFSFileSystem fs2 = new NPOIFSFileSystem(new ByteArrayInputStream(baos.toByteArray()))) {
                  // TODO
              }
          }
      }
   ...
   public void testCreateWriteRead() throws Exception {
       ...
       try (final NPOIFSFileSystem fs = new NPOIFSFileSystem()) {
      ...
      try (final NPOIFSFileSystem fs = new NPOIFSFileSystem(new ByteArrayInputStream(baos.toByteArray()))) {
