...
public final class TestAverageifs extends TestCase {
	...
	public void testExample1() {
        ...
        ValueEval[] args;
        // "=AVERAGEIFS(A2:A9, B2:B9, "=A*", C2:C9, 1)"
        args = new ValueEval[]{
        ...
        // "=AVERAGEIFS(A2:A9, B2:B9, "<>Bananas", C2:C9, 1)"
        args = new ValueEval[]{
                EvalFactory.createAreaEval("A2:A9", a2a9),
                EvalFactory.createAreaEval("B2:B9", b2b9),
                new StringEval("<>Bananas"),
        ...
        // "=AVERAGEIFS(A2:A9, B2:B8, "<>Bananas", C2:C9, 1)"
        args = new ValueEval[]{
                EvalFactory.createAreaEval("A2:A9", a2a9),
    ...
    public void testExample2() {
        ...
        // 0.5%	3%	1%	4%
        final ValueEval[] b5e5 = new ValueEval[] {
                new NumberEval(0.005),
                new NumberEval(0.03),
                new NumberEval(0.01),
                new NumberEval(0.04)
    ...
    public void testExample3() {
        ...
        // "=AVERAGEIFS(B2:E2, B3:E3, ">=40", B4:E4, "<10")"
        args = new ValueEval[]{
                EvalFactory.createAreaEval("B2:E2", b2e2),
                EvalFactory.createAreaEval("B3:E3", b3e3),
                new StringEval(">=40"),
    ...
    public void testFromFile() {
        ...
        final HSSFWorkbook wb = HSSFTestDataSamples.openSampleWorkbook("averageifs.xls");
        ...
        fe.evaluate(ex4cell);
        assertEquals(1.1666666666666667, ex4cell.getNumericCellValue());

        final HSSFSheet example5 = wb.getSheet("Example 5");
        final HSSFCell ex5cell = example5.getRow(9).getCell(2);
        fe.evaluate(ex5cell);
