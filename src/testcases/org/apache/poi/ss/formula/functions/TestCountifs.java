...
/**
 * Test cases for COUNTIFS()
 *
 * @author Zenichi Amano (sumifs original by Yegor Kozlov)
 */
public final class TestCountifs extends TestCase {

    private static final OperationEvaluationContext EC = new OperationEvaluationContext(null, null, 0, 1, 0, null);

	private static ValueEval invokeCountifs(final ValueEval[] args, final OperationEvaluationContext ec) {
		return new Countifs().evaluate(args, EC);
	}
	private static void confirmDouble(final double expected, final ValueEval actualEval) {
		if(!(actualEval instanceof NumericValueEval)) {
			throw new AssertionFailedError("Expected numeric result [actual=" + actualEval + "]");
		}
    ...
    private static void confirm(final double expectedResult, final ValueEval[] args) {
        confirmDouble(expectedResult, invokeCountifs(args, EC));
    }
	...
	public void testExample1() {
        ...
        // "=COUNTIFS(B2:B9, "<>Bananas", C2:C9, 1)"
        args = new ValueEval[]{
                EvalFactory.createAreaEval("B2:B9", b2b9),
                new StringEval("<>Bananas"),
                EvalFactory.createAreaEval("C2:C9", c2c9),
        ...
        // "=COUNTIFS(B2:B8, "<>Bananas", C2:C9, 1)"
        args = new ValueEval[]{
        ...
        assertEquals(ErrorEval.VALUE_INVALID, invokeCountifs(args, EC));
    ...
    public void testExample2() {
        ...
        // 1%	1.3%	2.1%	2%
        final ValueEval[] b4e4 = new ValueEval[] {
                new NumberEval(0.01),
    ...
    public void testFromFile() {
        ...
        final HSSFWorkbook wb = HSSFTestDataSamples.openSampleWorkbook("countifs.xls");
