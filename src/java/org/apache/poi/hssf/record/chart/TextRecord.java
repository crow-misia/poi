...
public final class TextRecord extends StandardRecord {
    ...
    public String toString()
    {
        ...
        buf.append("[TEXT]\n");
        buf.append("    .horizontalAlignment  = 0x")
            .append(HexDump.toHex(  getHorizontalAlignment ()))
            .append(" (").append( getHorizontalAlignment() ).append(" )\n");
        buf.append("    .verticalAlignment    = 0x")
            .append(HexDump.toHex(  getVerticalAlignment ()))
            .append(" (").append( getVerticalAlignment() ).append(" )\n");
        buf.append("    .displayMode          = 0x")
            .append(HexDump.toHex(  getDisplayMode ()))
            .append(" (").append( getDisplayMode() ).append(" )\n");
        buf.append("    .rgbColor             = 0x")
            .append(HexDump.toHex(  getRgbColor ()))
        ...
        buf.append("    .height               = 0x")
            .append(HexDump.toHex(  getHeight ()))
            .append(" (").append( getHeight() ).append(" )\n");
        buf.append("    .options1             = 0x")
            .append(HexDump.toHex(  getOptions1 ()))
            .append(" (").append( getOptions1() ).append(" )\n");
        buf.append("         .autoColor                = ").append(isAutoColor()).append('\n'); 
        buf.append("         .showKey                  = ").append(isShowKey()).append('\n'); 
        buf.append("         .showValue                = ").append(isShowValue()).append('\n'); 
        buf.append("         .vertical                 = ").append(isVertical()).append('\n'); 
        buf.append("         .autoGeneratedText        = ").append(isAutoGeneratedText()).append('\n'); 
        buf.append("         .generated                = ").append(isGenerated()).append('\n'); 
        buf.append("         .autoLabelDeleted         = ").append(isAutoLabelDeleted()).append('\n'); 
        buf.append("         .autoBackground           = ").append(isAutoBackground()).append('\n'); 
        buf.append("         .rotation                 = ").append(getRotation()).append('\n'); 
        buf.append("         .showCategoryLabelAsPercentage     = ").append(isShowCategoryLabelAsPercentage()).append('\n'); 
        buf.append("         .showValueAsPercentage     = ").append(isShowValueAsPercentage()).append('\n'); 
        buf.append("         .showBubbleSizes          = ").append(isShowBubbleSizes()).append('\n'); 
        buf.append("         .showLabel                = ").append(isShowLabel()).append('\n'); 
        buf.append("    .indexOfColorValue    = 0x")
            .append(HexDump.toHex(  getIndexOfColorValue ()))
            .append(" (").append( getIndexOfColorValue() ).append(" )\n");
        buf.append("    .options2             = 0x")
            .append(HexDump.toHex(  getOptions2 ()))
            .append(" (").append( getOptions2() ).append(" )\n");
        buf.append("         .dataLabelPlacement       = ").append(getDataLabelPlacement()).append('\n'); 
        buf.append("    .textRotation         = 0x")
            .append(HexDump.toHex(  getTextRotation ()))
