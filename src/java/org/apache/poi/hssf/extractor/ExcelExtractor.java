...
public class ExcelExtractor extends POIOLE2TextExtractor implements org.apache.poi.ss.extractor.ExcelExtractor {
    ...
    private static final class CommandParseException extends Exception {
        private static final long serialVersionUID = 7173348753162227702L;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (final ExcelExtractor extractor = new ExcelExtractor(wb)) {
    ...
    public String getText() {
        ...
        for(int i=0,n=_wb.getNumberOfSheets();i<n;i++) {
