...
public class Variant
{
    ...
    static
    {
        ...
        Map<Long, String> tm1 = new HashMap<>(73, 1.0f);
        ...
        numberToName = Collections.unmodifiableMap(tm1);

        /* Initialize the number-to-length map: */
        Map<Long, Integer> tm2 = new HashMap<>(73, 1.0f);
        tm2.put(Long.valueOf(0), LENGTH_0);
        tm2.put(Long.valueOf(1), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(2), LENGTH_2);
        tm2.put(Long.valueOf(3), LENGTH_4);
        tm2.put(Long.valueOf(4), LENGTH_4);
        tm2.put(Long.valueOf(5), LENGTH_8);
        tm2.put(Long.valueOf(6), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(7), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(8), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(9), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(10), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(11), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(12), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(13), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(14), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(16), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(17), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(18), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(19), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(20), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(21), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(22), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(23), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(24), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(25), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(26), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(27), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(28), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(29), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(30), LENGTH_VARIABLE);
        tm2.put(Long.valueOf(31), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(64), LENGTH_8);
        tm2.put(Long.valueOf(65), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(66), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(67), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(68), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(69), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(70), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(71), LENGTH_UNKNOWN);
        tm2.put(Long.valueOf(72), LENGTH_UNKNOWN);
