...
/**
 * Implementation for the Excel function COUNTIFS<p>
 *
 * Syntax : <br/>
 *  COUNTIFS ( <b>count_range</b>, <b>criteria_range1</b>, <b>criteria1</>,
 *  [<b>criteria_range2</b>,  <b>criteria2</b>], ...) <br/>
 *	<ul>
 *	  <li><b>count_range</b> Required. One or more cells to count, including numbers or names, ranges,
 ...
 */
public final class Countifs implements FreeRefFunction {
	...
	public ValueEval evaluate(final ValueEval[] args, final OperationEvaluationContext ec) {
		...
		try {
			...
			final AreaEval[] ae = new AreaEval[len/2];
			...
			final int result = countMatchingCells(ae, mp, range);
	 ...
	 * @param aeCount  the range to count
	 *
	 * @return the computed value
	 */
	private static int countMatchingCells(final AreaEval[] ranges, final I_MatchPredicate[] predicates, final AreaEval aeCount) {
		final int height = aeCount.getHeight();
		final int width = aeCount.getWidth();
