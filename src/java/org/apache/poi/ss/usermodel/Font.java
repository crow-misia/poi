...
public interface Font {
    ...
    public static final short BOLDWEIGHT_NORMAL = 0x190;

    /**
     * Bold boldness (bold)
     */

    public static final short BOLDWEIGHT_BOLD = 0x2bc;

    /**
     * normal type of black color.
     */

    public static final short COLOR_NORMAL = 0x7fff;

    /**
     * Dark Red color
     */

    public static final short COLOR_RED = 0xa;
