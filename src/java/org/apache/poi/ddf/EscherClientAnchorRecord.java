        ...
        extends EscherRecord
{
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab).append(formatXmlRecordHeader(getClass().getSimpleName(), HexDump.toHex(getRecordId()), HexDump.toHex(getVersion()), HexDump.toHex(getInstance())))
                .append(tab).append("\t<Flag>").append(field_1_flag).append("</Flag>\n")
                .append(tab).append("\t<Col1>").append(field_2_col1).append("</Col1>\n")
                .append(tab).append("\t<DX1>").append(field_3_dx1).append("</DX1>\n")
                .append(tab).append("\t<Row1>").append(field_4_row1).append("</Row1>\n")
                .append(tab).append("\t<DY1>").append(field_5_dy1).append("</DY1>\n")
                .append(tab).append("\t<Col2>").append(field_6_col2).append("</Col2>\n")
                .append(tab).append("\t<DX2>").append(field_7_dx2).append("</DX2>\n")
                .append(tab).append("\t<Row2>").append(field_8_row2).append("</Row2>\n")
                .append(tab).append("\t<DY2>").append(field_9_dy2).append("</DY2>\n")
