...
//        int pos = offset + 8 + 18 + remainingData.length;
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab).append(formatXmlRecordHeader(getClass().getSimpleName(), HexDump.toHex(getRecordId()), HexDump.toHex(getVersion()), HexDump.toHex(getInstance())))
                .append(tab).append("\t<RectX>").append(field_1_rectX1).append("</RectX>\n")
                .append(tab).append("\t<RectY>").append(field_2_rectY1).append("</RectY>\n")
                .append(tab).append("\t<RectWidth>").append(field_3_rectX2).append("</RectWidth>\n")
                .append(tab).append("\t<RectHeight>").append(field_4_rectY2).append("</RectHeight>\n");
