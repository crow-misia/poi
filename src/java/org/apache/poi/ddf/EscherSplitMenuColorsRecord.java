...
//        int field_2_numIdClusters = field_5_fileIdClusters.length + 1;
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab).append(formatXmlRecordHeader(getClass().getSimpleName(), HexDump.toHex(getRecordId()), HexDump.toHex(getVersion()), HexDump.toHex(getInstance())))
                .append(tab).append("\t<Color1>0x").append(HexDump.toHex(field_1_color1)).append("</Color1>\n")
                .append(tab).append("\t<Color2>0x").append(HexDump.toHex(field_2_color2)).append("</Color2>\n")
                .append(tab).append("\t<Color3>0x").append(HexDump.toHex(field_3_color3)).append("</Color3>\n")
                .append(tab).append("\t<Color4>0x").append(HexDump.toHex(field_4_color4)).append("</Color4>\n");
