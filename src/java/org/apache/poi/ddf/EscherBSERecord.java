...
public final class EscherBSERecord extends EscherRecord {
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab).append(formatXmlRecordHeader(getClass().getSimpleName(), HexDump.toHex(getRecordId()), HexDump.toHex(getVersion()), HexDump.toHex(getInstance())))
                .append(tab).append("\t<BlipTypeWin32>").append(field_1_blipTypeWin32).append("</BlipTypeWin32>\n")
                .append(tab).append("\t<BlipTypeMacOS>").append(field_2_blipTypeMacOS).append("</BlipTypeMacOS>\n")
                .append(tab).append("\t<SUID>").append(field_3_uid == null ? "" : HexDump.toHex(field_3_uid)).append("</SUID>\n")
                .append(tab).append("\t<Tag>").append(field_4_tag).append("</Tag>\n")
                .append(tab).append("\t<Size>").append(field_5_size).append("</Size>\n")
                .append(tab).append("\t<Ref>").append(field_6_ref).append("</Ref>\n")
                .append(tab).append("\t<Offset>").append(field_7_offset).append("</Offset>\n")
                .append(tab).append("\t<Usage>").append(field_8_usage).append("</Usage>\n")
                .append(tab).append("\t<Name>").append(field_9_name).append("</Name>\n")
                .append(tab).append("\t<Unused2>").append(field_10_unused2).append("</Unused2>\n")
                .append(tab).append("\t<Unused3>").append(field_11_unused3).append("</Unused3>\n");
